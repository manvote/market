...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadSnacks() {
    try {
      ...
      console.error("Error loading snacks products:", err);
      container.innerHTML = "<p>Failed to load snacks products. Please try again later.</p>";
    }
  }
  ...
  subcatBtns.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      // update subcat + reload snacks items
