...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadFragrance() {
    try {
      ...
      console.error("Error loading fragrance products:", err);
      container.innerHTML = "<p>Failed to load fragrance products. Please try again later.</p>";
    }
  }
  ...
  subcatBtns.forEach(btn => {
    btn.addEventListener("click", () => {
      ...
      // update subcat + reload fragrance items
